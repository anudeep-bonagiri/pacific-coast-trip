# Pacific Coast Road Trip — Aug 8–15 (8 days, 7 nights)

Seattle → LA, skipping the Olympic Peninsula. Three of you, Hertz car, cheap lodging. Extending the trip to Aug 15 bought two whole days: a **full Mount Rainier day** (sleep at the gate, hike Paradise at first light) and a **full LA day** that finally fits Griffith Observatory at sunset — no more racing a beach day to a flight. You still sleep in a bed every night, no overnight-split drives.
...
## 🌊 WATER SAFETY — read before you get in anything

**You cannot swim the northern half of this trip.** August water temps: Oregon coast **52–59°F**, San Francisco ~58°F. Wetsuit-only.

**Sneaker waves** on the Oregon/NorCal coast surge 150+ feet up the beach with no warning and have killed **24+ people on the West Coast since 2012**. The cold takes your limb control within seconds, and the waves carry sand/gravel that weighs your clothes down.

**Rules for Cannon Beach, Boardman, and the Redwood beaches:**
- Never turn your back on the ocean
- Stay off and away from beach logs (they roll and pin people)
- Keep well up the sand — wading is fine, swimming is not

**Swimmable water starts in SoCal:** Santa Monica/Malibu ~**69°F**, lifeguarded. That's Day 7, and it's where all three water activities live.
...
**Day 2 note (Rainier):** nothing near the park opens before 7 AM and there's no food (or gas) inside — buy breakfast + trail snacks the night before, in Seattle or Ashford.

**Estimate for these stops, all four travelers:** **$272–440 before tax and tip**. See [`food.html`](food.html) for exact safe orders, hours, public-menu links, backups, and per-day cost controls. Recheck ingredients and prices 24–48 hours before each stop.

---

## Day-by-day

### DAY 1 — Sat Aug 8 · Land SEA → Seattle → Rainier gate
| Time | Plan |
|---|---|
| 2:50 PM | Land SEA (DL1045), bags by ~3:30 |
| ~3:45 PM | **Hertz pickup** — straight to the counter; no car-less downtown window with this landing time |
| ~4:30 PM | **Pike Place Market** — park once (Pike Place garage); **Pike Place Chowder**: vegan Lime & Coconut for the vegetarians, Smoked Salmon or Seafood Bisque for the other two |
| ~5:30 PM | Walk down to the **waterfront** → **Seattle Great Wheel** (Pier 57, ~$20) |
| *+optional* | **Space Needle / Chihuly Garden** (~$40) — only if you're ahead of schedule; Kerry Park matters more |
| ~7:30 PM | **Kerry Park** — THE Seattle postcard: skyline, Elliott Bay, and Rainier floating behind the city (you stand on its summit road tomorrow). Sunset ~8:25; leave by 8 |
| ~8:00 PM | Drive ~2 hr to Ashford. **Buy breakfast food + hike snacks tonight** — nothing opens before 7 AM |
| ~10:15 PM | **Ashford / Elbe (Rainier gate)** — sleep. **BOOK NOW** — it's an August Saturday at a national-park gateway. Campsite alternative: Cougar Rock (inside the park) |

### DAY 2 — Sun Aug 9 · Mount Rainier → the coast
| Time | Plan |
|---|---|
| 6:00 AM | **Nisqually Entrance** — in before 7 AM: historically exempt from timed-entry windows (**VERIFY 2026 rules on nps.gov**), no line, first light on the mountain. $30/vehicle, card OK. Full tank in Ashford — **no gas in the park** |
| en route | **Christine Falls** (+10 min, roadside) |
| 6:45 AM | **Narada Falls** — short steep path to the base viewpoint |
...
## Cost — 8 days, 7 nights, 3 people

| Item | Total | Per person |
|---|---|---|
| Flights | $777 | $259 *(update with the actual Aug 15 fare)* |
| Rental car (8 days) | ~$1,060 | ~$353 |
| Gas | ~$290 | ~$97 |
| Lodging (7 nights, 1 cheap room) | ~$980 | ~$327 |
...
Range: **$4,700 (frugal)** to **$5,500**. The two extra days cost ~$320/person over the 6-day version — and they buy a full Rainier day (the best day-hike in Washington) and an unhurried LA day that ends at Griffith at sunset instead of a security line.
...
Sources: [NOAA sneaker wave safety](https://www.weather.gov/safety/sneaker-waves) · [Redwood NP beach safety](https://www.nps.gov/redw/planyourvisit/upload/BeachSafety-Dec06-508.pdf) · [Oregon water temps](https://www.currentresults.com/Oceans/Temperature/oregon-average-water-temperature.php) · [California summer ocean temps](https://www.currentresults.com/Oceans/Temperature/pacific-ocean-temperature-california-summer.php) · [Mount Rainier timed entry](https://www.nps.gov/mora/planyourvisit/timed-entry-reservations.htm) · [Caltrans Big Sur Hwy 1](https://dot.ca.gov/caltrans-near-me/district-5/district-5-current-projects/big-sur-highway-1) · [Monterey Car Week](https://www.seemonterey.com/events/monterey-car-week/) · [Fern Canyon permits](https://www.nps.gov/redw/planyourvisit/ferncanyonpermits.htm)
